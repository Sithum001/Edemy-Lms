...
const Companies = () => {
  return (
    <div className='pt-16'>
      ...
      <div className='flex flex-wrap items-center justify-center gap-6 md:gap-16md:mt-10 mt-5'>
        ...
        <img src={assets.accenture_logo} alt="Accentura" className='w-20 md:w-28' />
