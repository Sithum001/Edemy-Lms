...
const CoursesList = () => {
  ...
  return (
    ...
    <div className='relative md:px-36 px-8 pt-20 text-left'>
      ...
      <div>
        <h1 className='text-4xl font-semibold text-gray-800'>Course Link</h1>
      ...
      <div className='grid grid-cols-1 sm:grip-cols-2 md:grid-cols-3 lg:grid-cols-4 my-16 gap-3 px-2 md:p-0'>
