...
const CourseDetails = () => {
  ...
  const fetchCourseData = async ()=>{
    ...
    if (findCourse && findCourse.courseContent) {
      const initialState = {}
      findCourse.courseContent.forEach((_, index) => {
        ...
        <p className='pt-4 md:text-base text-sm' dangerouslySetInnerHTML={{__html: courseData.courseDescription.slice(0, 200)}}></p>
           ...
           {/* review and rating */}
            ...
            <div className='flex items-center space-x-2 pt-3 pb-1 text-sm '>
                     ...
                     <p>{courseData.enrolledStudents.length}{courseData.enrolledStudents.length > 1 ? 'ratings' : 'rating'}</p>
             </div> 

             <p className='text-sm'>Course by
              <span className='text-blue-600 underline'>Edamy</span>
             </p>
       ...
       {             
        ...
        <div className='p-5'>
          <div className='flex items-center gap-2'>
                    ...
                    :<img className='w-305' src={assets.time_clock_icon} alt="time_clock_icon" />
          ...
          <button className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium'>{isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now' }
          </button>
          <div className='pt-6'>
